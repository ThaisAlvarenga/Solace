...
namespace ToonBoom.Harmony
{
    ...
    public struct SoundData
    {
        ...
        public SoundData(string soundName, float startFrame)
        {
            SoundName = soundName;
    ...
    [Serializable]
    public struct ClipContents
    {
        public string ClipName;
        public List<SoundData> Sounds;

        public ClipContents(string clipName, List<SoundData> sounds)
        {
            ClipName = clipName;
            Sounds = sounds;
        }
    ...
    public struct Spritesheet : IEquatable<Spritesheet>
    {
        ...
        public bool HasValidSprites()
        {
            ...
            {
                Debug.LogWarning("No valid sprites found");
                return false;
            }
            return true;
        }
