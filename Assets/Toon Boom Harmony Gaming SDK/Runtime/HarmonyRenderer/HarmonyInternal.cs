...
namespace ToonBoom.Harmony
{
    internal class HarmonyInternal
    {
        ...
        public static extern int UpdateRenderScript(int scriptId, int projectId, IntPtr clipName, IntPtr sheetResolution, float frame, int discretizationStep);
        ...
        public static extern void UpdateSkins(int scriptId, UIntPtr skins, int skinCount);
        ...
        [DllImport("__Internal")]
        public static extern bool CalculateLocatorTransform( int projectId, IntPtr clipName, float frame, IntPtr locatorName, IntPtr position, IntPtr rotation, IntPtr scale);
