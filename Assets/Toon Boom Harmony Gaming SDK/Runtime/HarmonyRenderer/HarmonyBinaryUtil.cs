    ...
    public static class HarmonyBinaryUtil
    {
        ...
        public static void FillProjectFromBinary(HarmonyProject project, byte[] binaryFile)
        {
            ...
            using (BinaryReader reader = new BinaryReader(stream))
            {
                ...
                ExtractSheetNamesData(reader, header.Sheetnames, project.SpriteSheets);
                ExtractSpritesData(reader, header.CustomSprites, project.CustomSprites, project.SpriteSheets);
        ...
        private static void InitializeLists(in HarmonyInternal.Header header, HarmonyProject project)
        {
            ...
            project.SpriteSheets = new List<Spritesheet>((int)header.Sheetnames.Count);
