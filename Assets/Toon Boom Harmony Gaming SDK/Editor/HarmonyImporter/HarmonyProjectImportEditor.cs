...
namespace ToonBoom.Harmony
{
    ...
    {
        public delegate void ProjectPreimportDelegate(HarmonyProjectImport projectImport);
        public static ProjectPreimportDelegate OnHarmonyProjectPreimport; 
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button("Import"))
            {
                ...
                if (OnHarmonyProjectPreimport != null)
                {
                    OnHarmonyProjectPreimport(import); 
                }
