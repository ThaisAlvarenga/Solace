    ...
    public class PanCamera : MonoBehaviour
    {
        ...
        void Update()
        {
            if (attachedCamera != null)
            {
              ...
              #else
                //  Pan.
                if (Input.GetKey(KeyCode.Mouse0) && !isGUIUsed)
                {
                    if (isDragging)
                    {
                ...
                {
                    attachedCamera.orthographicSize = Mathf.Clamp(attachedCamera.orthographicSize + zoomSpeed, 2, 60);
                }
